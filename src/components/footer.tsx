...
const Footer = () => {
  const currentGoldRate = 7000; // This would typically come from an API or state
...
<div className="bg-gray-800 w-1/2 p-4 rounded-lg">
<p className="text-[#ffffff] text-2xl font-bold">₹{currentGoldRate}</p>
